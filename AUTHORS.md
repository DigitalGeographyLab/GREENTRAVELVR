...
These people have contributed substantially to the code, VR environment, or technical design of **GREENTRAVELVR**:

- Omkaranathan Ravindran – VR specialist and lead developer `omkaranathan.ravindran[at]helsinki.fi`
- Ashish Shete – 3D Computer Graphics specialist and developer `ash.uni.helsinki[at]gmail.com`
- Jussi Torkko – PhD Researcher `jussi.torkko[at]helsinki.fi` 
...
- Technical / VR environment: *Omkaranathan Ravindran* 
- General GREENTRAVEL project contact: `greentravel-project[at]helsinki.fi`
## How to cite

If you use this repository in academic or applied work, please cite it as:

> Digital Geography Lab (2025). *GREENTRAVELVR: Source code and documentation for the GREENTRAVEL virtual reality environment*. GitHub repository. Available at: https://github.com/DigitalGeographyLab/GREENTRAVELVR

You may also wish to cite the relevant GREENTRAVEL publications describing the VR cycling experiments and greenery exposure analyses; see the publication list on the GREENTRAVEL project page.
